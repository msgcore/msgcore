...
const CONTRACTS = [
  {
    ...
    "typeDefinitions": {
      ...
      "CheckoutResponseDto": "export interface CheckoutResponseDto {\n  sessionId: string;\n  url: string;\n}",
      ...
      "CreateCheckoutDto": "export interface CreateCheckoutDto {\n  tier: SubscriptionTier;\n  interval: 'monthly' | 'annual';\n}",
      ...
      "PlatformType": "export type PlatformType = 'discord' | 'telegram' | 'whatsapp-evo' | 'whatsapp-baileys' | 'email';",
      "PortalResponseDto": "export interface PortalResponseDto {\n  url: string;\n}",
      ...
      "SubscriptionStatus": "export type SubscriptionStatus = 'ACTIVE' | 'CANCELED' | 'PAST_DUE' | 'TRIALING' | 'UNPAID';",
      "SubscriptionTier": "export type SubscriptionTier = 'FREE' | 'STARTER' | 'PRO' | 'BUSINESS' | 'ENTERPRISE';",
